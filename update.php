...
{
  if(@$_GET['demail'] && $_SESSION['key']=='qwer') 
  {
    $demail=@$_GET['demail'];
  ...
  {
    if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='qwer') 
    {
      $eid=@$_GET['eid'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='qwer') 
    {
      $name = $_POST['name'];
  ...
  if(isset($_SESSION['key']))
  {
    if(@$_GET['q']== 'addqns' && $_SESSION['key']=='qwer') 
    {
      $n=@$_GET['n'];
      $eid=@$_GET['eid'];
      $ch=@$_GET['ch'];
